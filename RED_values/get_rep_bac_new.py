...
for clade in tree.find_clades():
    if clade.is_terminal() == True:
        ...
        count = count + 1
rep_diction = sys.argv[1]
rep_dic_id = rep_diction.split('.json')[0].split('subset_')[1]

rep_list = list(rep_diction.keys())

with open('/nesi/nobackup/uc04105/new_databases_May/final_tree_set/RED_values_Bacteria_clusters_8okt_rep_dic_id.tsv', 'w') as WRED:
