...
TypesE$species_name <- gsub("Agaricus_bisporus_", "Agaricus_bisporus_ var. bisporus H97", TypesE$species_name)
...
IT_Bacteria<- merge(IT_Bacteria, TypesB, by ='GTDB_id', all =TRUE)
...
```{r}
IT_B_allAntiporters <- IT_Bacteria[IT_Bacteria$Antiporter_count > 0,]
```
...
Bacteria_average_ap_mb <- Bacteria_average_ap_mb[Bacteria_average_ap_mb$Phyla %in% top_Bac_phyla,]
```
