...
#07
#hmmsearch --noali --cpu 10 -E 0.0000001 --tblout ${HMMsearch}/PF00999_07_vsEuk.tsv ${HMMdir}/PF00999.hmmm
 ${Euk_DB}

#python getting_fasta_from_hit_extra.py ${HMMsearch}/PF00999_07_vsEuk.tsv HMM ${Euk_TSV} ${HMMsearch}/PF00
0999_07_vsEuk.fasta EukM6

#hmmalign --amino --trim -o /nesi/nobackup/uc04105/new_databases_May/Euk_database_May/results/HMMalign/PFF
00999_07_vsEuk_AlignedPF00999.sthk /nesi/nobackup/uc04105/results/HMM/PF00999.hmm /nesi/nobackup/uc04105//
new_databases_May/Euk_database_May/results/HMMsearch/PF00999_07_vsEuk.fasta

python parse_stockholm_filter.py ${HMMalign}/PF00999_07_vsEuk_AlignedPF00999.sthk ${HMMalign}/PF00999_07__
vsEuk_AlignedPF00999 257
