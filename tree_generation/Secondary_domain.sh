...
IN=/nesi/nobackup/uc04105/new_databases_May/final_tree_set/prefered_sequences
...
python parse_stockholm_special.py ${IN}/HMMalign/${array[$SLURM_ARRAY_TASK_ID]}_fl_vsPF02254_TrkN.sthk ${IN}/HMMalign/${array[$SLURM_ARRAY_TASK_ID]}_fl_vsPF02254_TrkN 81
