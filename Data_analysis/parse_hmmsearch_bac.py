import sys
import os
Bac_sequences_passed_thresholds = {}
...
for record in SeqIO.parse('/nesi/nobackup/uc04105/new_databases_May/final_tree_set/second_set/Bacteria_passed_all_filters_OKT3_GTDBreps_alignedPF00999.fasta','fasta'):
    Bac_sequences_passed_thresholds[str(record.id)] = record.seq
Hmmsearch = '/nesi/nobackup/uc04105/new_databases_May/comparative_hmmsearch/Bacteria'
...
for sequence in sequences_hit_by_pf009999:
    if sequence in  Bac_sequences_passed_thresholds:
        list_pf00999_passed.append(sequence)
print(len(set(list_pf00999_passed)))
