 ...
 **Step 5.** Run a quality control by aligning the sequences against their respective HMM, so for PF03600:
  ...
  **Step 7.** The sequences whom pass both the HMMscan and HMMalign are the high confidence homologs. 
  ...
  Using a python script Parse_All_antiporter_hits_in_GTDB226_Archaea(H9oA).py for Archaea.
                        Parse_All_antiporter_hits_in_inh_EUK(H9oE).py for Eukarya
                        Parse_All_antiporter_hits_GTDB226Bacteria(H9oB).py for Bacteria. (this script also retrieves fl of CPA, the ones for Archaea and Eukarya do not)
