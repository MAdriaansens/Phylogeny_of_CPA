...
with open('/nesi/nobackup/uc04105/new_databases_May/final_april28/Eukarya_types_subclades_per_protein_id.tsv', 'w') as out_tsv:
    ...
    if 'EukM6' in key:
        ...
        if key[0].isnumeric():
            ...
            if clade_dic[key][2] == '8':
                with open("/nesi/nobackup/uc04105/new_databases_May/final_april28/fl/Euk_NHX_sequences.faa", "a") as NHXout:
...
with open('/nesi/nobackup/uc04105/new_databases_May/final_april28/CPA_types_Eukarya_June8.tsv', 'w') as TAX_TYPE:
