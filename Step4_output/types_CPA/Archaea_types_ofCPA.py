...
MMseq= '/nesi/nobackup/uc04105/new_databases_May/final_april28/tree_input/Archaea_April_hmmaligned_e03_mmseq_treeinput_clusterd_at_0.7.faa_cluster.tsv'
rep_list = []
...
tax_list = []
for record in SeqIO.parse('/nesi/nobackup/uc04105/new_databases_May/final_april28/fl/Archaea_CPA_fl.fasta','fasta'):
            ...
            if clade_dic[key] == '8':
                ...
                if key in Reps_dic:
                    ...
                    for entry in Reps_dic[key]:
                        with open("/nesi/nobackup/uc04105/new_databases_May/final_april28/fl/Arc_NhaS5_sequences.faa", "a") as NhaS5out:
                            sequence  = seq_dic[entry.split(':')[0]][1]
                            id_tax =  seq_dic[entry.split(':')[0]][0]
                ...
                if key in Reps_dic:
                    ...
                    for entry in Reps_dic[key]:
                        with open("/nesi/nobackup/uc04105/new_databases_May/final_april28/fl/Arc_Undescribed_CPA1_sequences.faa", "a") as Undescribed_CPA1out:
                            sequence  = seq_dic[entry.split(':')[0]][1]
                            id_tax =  seq_dic[entry.split(':')[0]][0]
                ...
                if key in Reps_dic:
                    for entry in Reps_dic[key]:
                        with open("/nesi/nobackup/uc04105/new_databases_May/final_april28/fl/Arc_SOD2_sequences.faa", "a") as SOD2out:
                            sequence  = seq_dic[entry.split(':')[0]][1]
                            id_tax =  seq_dic[entry.split(':')[0]][0]
                ...
                if key in Reps_dic:
                    for entry in Reps_dic[key]:
                        with open("/nesi/nobackup/uc04105/new_databases_May/final_april28/fl/Arc_NhaPCPA1_sequences.faa", "a") as NhaPCPA1out:
                            sequence  = seq_dic[entry.split(':')[0]][1]
                            id_tax =  seq_dic[entry.split(':')[0]][0]
                ...
                if key in Reps_dic:
                    for entry in Reps_dic[key]:
                        with open("/nesi/nobackup/uc04105/new_databases_May/final_april28/fl/Arc_UndProkaryaCPA1IDK_sequences.faa", "a") as UndProkaryaCPA1IDKout:
                            sequence  = seq_dic[entry.split(':')[0]][1]
                            id_tax =  seq_dic[entry.split(':')[0]][0]
                ...
                if key in Reps_dic:
                    for entry in Reps_dic[key]:
                        with open("/nesi/nobackup/uc04105/new_databases_May/final_april28/fl/Arc_GerN_sequences.faa", "a") as GerNout:
                            sequence  = seq_dic[entry.split(':')[0]][1]
                            id_tax =  seq_dic[entry.split(':')[0]][0]
                ...
                if key in Reps_dic:
                    for entry in Reps_dic[key]:
                        with open("/nesi/nobackup/uc04105/new_databases_May/final_april28/fl/Arc_CPA1_SL_sequences.faa", "a") as CPA1_SLout:
                            sequence  = seq_dic[entry.split(':')[0]][1]
                            id_tax =  seq_dic[entry.split(':')[0]][0]
                ...
                if key in Reps_dic:
                    for entry in Reps_dic[key]:
                        with open("/nesi/nobackup/uc04105/new_databases_May/final_april28/fl/Arc_Uncharacterized_sequences.faa", "a") as Uncharacterizedout:
                            sequence  = seq_dic[entry.split(':')[0]][1]
                            id_tax =  seq_dic[entry.split(':')[0]][0]
...
with open('/nesi/nobackup/uc04105/new_databases_May/final_april28/CPA_types_Archaea_5may.tsv', 'w') as TAX_TYPE:
