...
genomedir=~/chloroplast_mitochondria_genomes/database
seed_dir=~/chloroplast_mitochondria_genomes/euk_cpa_seeds
tblastnout=~/chloroplast_mitochondria_genomes/blastn_output
